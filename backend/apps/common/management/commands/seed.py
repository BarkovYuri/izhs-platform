...
SETTINGS_DEFAULTS = {
    "site_name": "Ремстрой",
    "tagline": "Кирпичные дома в ЖК «Красная смородина»",
    ...
    "inn": "701716191942",
    "about_short": (
        "Строим кирпичные дома в ЖК «Красная смородина» (Кисловка) "
    ...
    "seo_description_default": (
        "Строительство кирпичных домов в ЖК «Красная смородина» "
