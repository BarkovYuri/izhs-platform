...
хотя бы 3 фото) — у них есть фиксированный адрес и координаты посёлка.
Вариант «строим на вашем участке» сюда не годится: это услуга, а не
конкретный объект недвижимости с адресом.
