...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    icons: {
      // app/favicon.ico → Next.js сам добавит <link> в head.
      // Здесь — PNG для Google Search (он рендерит ~48px из icon-192/512),
      // SVG для современных браузеров, apple-touch для iOS Safari.
      icon: [
